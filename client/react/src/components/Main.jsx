...
function Main() {
  return (
    <div className=" min-h-screen flex flex-col justify-center items-center bg-custom-blue text-custom-white max-h-[calc(100vh-HeaderHeight-FooterHeight)] overflow-auto">

      ...
      <div className="xs:mt-[200px] mt-[100px] xs:w-full md:w-[400px]">
        ...
        <div className="flex justify-between items-center ">
          <div className="flex items-center boar ">
            {user.img_url === null ? (
              <img src={basicProfile} alt="profile" className="w-[70px] h-[70px] mb-3 mt-2 rounded-sm " />
            ) : (
              <img
        ...
        <div className="text-xl mt-4">
          ...
          <div className="mt-2 sm:mt-2 md:mt-2">
            ...
            <div className="mt-10">
              ...
              <div className="flex w-full mt-5 text-base ">
                ...
                <Link to="/SelectGenre" className="text-custom-lightgray w-30 ml-5 self-center text-sm w-[50px]">
                  더보기
                </Link>
              </div>
            </div>
          ...
          <div className="flex items-start w-full mt-2 ">
            ...
            <Link to="/Artistrecommend" className="text-custom-lightgray w-30 ml-5 self-center text-sm w-[50px]">
              더보기
            </Link>
          </div>
          {/* 로그아웃 */}

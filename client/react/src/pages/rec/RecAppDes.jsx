...
const RecAppDes = () => {
  ...
  return (
    <div className='bg-gradient-to-t from-gray-900 via-stone-950 to-gray-700 text-custom-lightblue p-3 h-full item-center justify-center overflow-scroll'>
        ...
        {/* 위치 이미지  */}
        <div className='flex flex-row py-5 item-center justify-center ml-[50px] xs:ml-[2px]'>
          <img src={watchLogin} className=' w-[180px] h-[220px] ' />
          <img src={watchHeartRate} className='w-[178px] h-[210px]' />
        </div>
        ...
        <ul>
            ...
            <ol className=' tracking-tight mt-3 leading-loose'>
                <li className="-indent-[70px]">1. 미워치에서 샤오미웨어를 실행합니다.</li>
                <li >2. 검색창에 Blueme를 검색하고 다운로드 받습니다.</li>
                <li className="-indent-5">3. 앱 설치가 완료되면 자사 로그인을 진행합니다.</li>
                <li className="indent-1.5">4. 데이터가 워치에 보여지면 전송 버튼을 클릭합니다.</li>
            </ol>

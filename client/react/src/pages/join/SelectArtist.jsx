...
const SelectArtist = () => {
    ...
    const handleOnSubmit = () => {
        const checkedIndices = checkedState.reduce(
            (indices, item, index) => [...indices, ...(item ? [index] : [])],
            []
        );

        navigate('/Main', { state: { selectedArtists: checkedIndices } });
    };
    return (
                ...
                {Array(12)
                    ...
                    .map((_, i) => (
                        ...
                        >
                            ...
                            {checkedState[i] && (
                                <span className="absolute top-[30%] left-[40%] text-xl font-bold">✔</span>
                            )}
                        </button>
                    ))}
            </div>
